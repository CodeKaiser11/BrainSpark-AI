      ...
      <div className="mt-16 w-full max-w-4xl bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div className="p-8 md:p-12 flex flex-col gap-6">
          <div className="flex gap-4 max-w-lg">
            <div className="w-10 h-10 rounded-full bg-brand-dark shrink-0"></div>
          ...
          <div className="flex gap-4 max-w-2xl self-end flex-row-reverse">
            <div className="w-10 h-10 rounded-full bg-brand-orange flex items-center justify-center text-white text-xl shrink-0 shadow-md">🧠</div>
